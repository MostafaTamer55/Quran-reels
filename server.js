...
app.post('/api/make-video', async (req, res) => {
    // استلام الرابط المباشر للصوت والآيات من الـ JSON مباشرة بدون multer
    ...
    try {
        ...
        // FFmpeg سيقرأ الرابط مباشرة أونلاين ويقص أول ثوانٍ منه فوراً دون استهلاك للرام
        ffmpeg()
            .input(audioUrl) 
            .inputOptions([`-ss 00:00:00`, `-t ${totalDuration}`]) 
